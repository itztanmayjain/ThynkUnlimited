...
if(isset($_SESSION['User']))
{
  ...
  if(isset($_POST['upload']))
  {
      ...
      $update_Query = "UPDATE `courses` set `coursetitle` = '$title', `FieldId` = '$field_id', `shortdesc` = '$short_desc', `learn1` = '$learn1', `learn2` = '$learn2', `learn3` = '$learn3', `learn4` = '$learn4', `overview` = '$overview' , `price` = '$price' ,`field` = '$field', `image` = '$field_img' WHERE  `cid` = '$id' ";
      ...
      try{
        $update_Result = mysqli_query($con, $update_Query);
              ...
              echo '
                <script type="text/javascript">
                  ...
                  $(document).ready(function(){
                    ...
                    swal({
                      title: "Updated!",
                      text: "You update course succesfully",
                      icon: "success",
          ...
          if($position == "Admin"){
            ...
            header("location:created_course.php");
          }
          ...
          <form action="#" class="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-step form-step-active">
              <div class="input-group">
                ...
                <input type="text" name="title" id="title" value="<?php echo $row['coursetitle'];?>" />
              </div>
              <div class="input-group">
                <label for="shortdesc">Short Description</label>
                <input type="text" name="shortdesc" id="shortdesc" value="<?php echo $row['shortdesc'];?>"/>
              </div>
            ...
            <div class="form-step">
              <div class="input-group">
                ...
                <input type="text" name="Learn1" id="Learn1" placeholder="What you'll Learn" value="<?php echo $row['learn1'];?>"/>
              </div>
              <div class="input-group">
                <label for="Learn2">Learn2</label>
                <input type="Learn2" name="Learn2" id="Learn2"  placeholder="What you'll Learn" value="<?php echo $row['learn2'];?>"/>
              </div>
              <div class="input-group">
                <label for="Learn3">Learn3</label>
                <input type="text" name="Learn3" id="Learn3"  placeholder="What you'll Learn" value="<?php echo $row['learn3'];?>" />
              </div>
              <div class="input-group">
                <label for="Learn4">Learn4</label>
                <input type="text" name="Learn4" id="Learn4"  placeholder="What you'll Learn" value="<?php echo $row['learn4'];?>" />
              </div>
            ...
            <div class="form-step">
              <div class="input-group">
                ...
                <textarea name="blogtext"> <?php echo $row['overview'];?>  </textarea>
              </div>
              <div class="input-group">
            ...
            <div class="form-step">
              <div class="input-group">
                ...
                <select name="underfield" id="field" value="<?php echo $row['field'];?>">
