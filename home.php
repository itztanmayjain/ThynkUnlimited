...
<header class="header">
    ...
    <a href="login.php"> <input type="submit" value="login now" class="btn"></a>
        <p>-------------------OR-----------------</p>
        <a href="registration.php"> <input type="submit" value="Register now" class="btn"></a>
...
<section class="credit"><i class="far fa-copyright"></i> 2022-23 All Rights Reserved! | Powered by <b>Thynk Unlimited</b></section>
