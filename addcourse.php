...
{
  //UnderGroup Dropdown
  $select_UG_Query = "SELECT * FROM `tabundergroup` WHERE `visible` = 1";
  $select_UG_Result = mysqli_query($con, $select_UG_Query);

  //UnderField Dropdown
  $select_UF_Query = "SELECT * FROM `tabunderfield` WHERE `visible` = 1";
  ...
  if(isset($_POST['upload']))
  {
      ...
      $select_field_Query = "SELECT * FROM `tabunderfield` WHERE `name` = '$field'";
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            <ul>
              ...
              <li><a href="addcourse.php" class="active">
          ...
          <form action="#" class="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-step">
              <div class="input-group">
                ...
                <textarea rows="4" cols="50" placeholder="Enter Description" name="blogtext" class="box">  </textarea>
              </div>
              <div class="input-group">
