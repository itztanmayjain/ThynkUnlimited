...
if(isset($_POST['add_field'])){
   ...
   $field_shortdesc = $_POST['field_shortdesc'];
   ...
   if(empty($field_name) || empty($field_desc) || empty($field_img)){
      ...
      $insert = "INSERT INTO `tabaddblog`(`name`, `shortdesc` ,`description` , `image`,`createdby`, `visible`) VALUES('$field_name', '$field_shortdesc' ,'$field_desc', '$field_img', '$user', '$field_visible')";
...
if(isset($_GET['delete'])){
   $id = $_GET['delete'];
   mysqli_query($con, "DELETE FROM tabaddblog WHERE id = $id");
...
<body>
    <div class="wrapper">
        ...
        <div id="id01" class="modal">
            ...
            <div class="container">
                <h1>Sign Out</h1>
                <p>Are you sure to sign out your account?</p>
   ...
   <div class="admin-product-form-container">
      ...
      <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
         ...
         <input type="description" placeholder="Enter Short Description " name="field_shortdesc" class="box">
         <textarea rows="4" cols="50" placeholder="Enter Description" name="field_desc" class="box"></textarea>
         ...
         <input type="submit" class="btn add" name="add_field" value="Add Blog">
      </form>
   ...
   $select = mysqli_query($con, "SELECT * FROM tabaddblog");
   ...
   <div class="product-display">
      <table class="product-display-table">
         ...
         <tr>
            ...
            <td>
               <a href="updateblog.php?edit=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-edit"></i> edit </a>
               <a href="addblog.php?delete=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-trash"></i> delete </a>
            </td>
         </tr>
      <?php } ?>
      </table>
